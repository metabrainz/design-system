        ...
        <div className="row">
          ...
          >
            ...
            <ul className="list-unstyled">
              ...
              <li className="color-a">
                <span className="color-gray">Discussion IRC: </span> <a href={'https://kiwiirc.com/nextclient/irc.libera.chat/?#' + props.projectName} rel="noopener noreferrer" target="_blank"> #{props.projectName}</a>
              </li>
              <li className="color-a">
          ...
          <div className="col-sm-12 col-md-3 section-md-t3">
            ...
            <ul className="list-unstyled">
              <li className="item-list-a">
                <i className="bi bi-chevron-right" /> <a href="https://metabrainz.org/donate" rel="noopener noreferrer" target="_blank">Donate</a>
              </li>
              <li className="item-list-a">
                <i className="bi bi-chevron-right" /> <a href="https://wiki.musicbrainz.org/Main_Page" rel="noopener noreferrer" target="_blank">Wiki</a>
              </li>
              <li className="item-list-a">
                <i className="bi bi-chevron-right" /> <a href="https://community.metabrainz.org/" rel="noopener noreferrer" target="_blank">Community</a>
              </li>
              <li className="item-list-a">
                <i className="bi bi-chevron-right" /> <a href="https://blog.metabrainz.org/" rel="noopener noreferrer" target="_blank">Blog</a>
              </li>
              <li className="item-list-a">
                <i className="bi bi-chevron-right" /> <a href="https://www.redbubble.com/people/metabrainz/shop" rel="noopener noreferrer" target="_blank">Shop</a>
              </li>
              <li className="item-list-a">
                <i className="bi bi-chevron-right" /> <a href="https://metabrainz.org/" rel="noopener noreferrer" target="_blank">MetaBrainz</a>
              </li>
          ...
          <div className="col-sm-12 col-md-3 section-md-t3">
            ...
            <ul className="list-unstyled">
              <li className="image-container item-list-a">
                ...
                <div className="image">
                  <img alt="image" height="24" src="/assets/img/meb-icons/ListenBrainz.svg" width="24" />
                </div>
              ...
              <li className="image-container item-list-a">
                <i className="bi bi-chevron-right" />
                <div className="image">
                  <img alt="image" height="24" src="/assets/img/meb-icons/CritiqueBrainz.svg" width="24" />
                </div>
              ...
              <li className="image-container item-list-a">
                <i className="bi bi-chevron-right" />
                <div className="image">
                  <img alt="image" height="24" src="/assets/img/meb-icons/Picard.svg" width="24" />
                </div>
              ...
              <li className="image-container item-list-a">
                <i className="bi bi-chevron-right" />
                <div className="image">
                  <img alt="image" height="24" src="/assets/img/meb-icons/BookBrainz.svg" width="24" />
                </div>
              ...
              <li className="image-container item-list-a">
                <i className="bi bi-chevron-right" />
                <div className="image">
                  <img alt="image" height="24" src="/assets/img/meb-icons/AcousticBrainz.svg" width="24" />
                </div>
              ...
              <li className="image-container item-list-a">
                <i className="bi bi-chevron-right" />
                <div className="image">
                  <img alt="image" height="24" src="/assets/img/meb-icons/CoverArtArchive.svg" width="24" />
                </div>
        ...
        <div className="row center-p">
          <div className="col-md-3 d-none d-md-block">
            <p className="color-gray section-line">
              OSS Geek?  <a href={props.sourceCode} rel="noopener noreferrer" target="_blank"> <span className="color-a"> Contribute Here </span> </a>
            </p>
          </div>
          <div className="col-md-6">
            <p className="section-line image-container copyright ">
              Brought to you by
              <div className="image">
                <img alt="image" height="24" src="/assets/img/meb-icons/MetaBrainz.svg" width="24" />
              </div>
