    ...
    .add('Hey there 👋', withInfo('')(() => (
        <div>
            ...
            <p style={{marginBottom: '1em', marginTop: '1em', maxWidth: '40vw'}}>
                {'This storybook is around to help you find your way around our UI components. We hope it will help ' +
                'us maintain a scalable and consistent visual system for UI development. Look around and feel free to' +
                ' reach out to us on IRC #metabrainz to talk about it! 😀'}
            </p>
    ...
    .add('Info Alert', withInfo('')(() => (
        <div>
            <AlertDismissable bsStyle="info">
                <p>
                    {'Hmm, you cannot edit it. Permissions to delete this entity are only granted to privileged ' +
                    'editors. Click'}
                    <a className="alert-link">{'here'}</a>
                    {'to know more!'}
                </p>
