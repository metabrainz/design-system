...
const MarginDecorator = (storyFn) => <div style={margins}>{storyFn()}</div>;
    ...
    () => (
      <div>
        <AlertDismissable variant="info">
          <p>
            {
              'Hmm, you cannot edit it. Permissions to delete this entity are only granted to privileged editors. Click'
            }{' '}
...
storiesOf('Buttons', module)
  .add(
    ...
    () => (
      <div>
        ...
        <Button onClick={action('clicked')} size="sm" variant="primary">
  ...
  .add(
    ...
    () => (
      <div>
        ...
        <Button onClick={action('clicked')} size="sm" variant="secondary">
  ...
  .add(
    ...
    () => (
      <div>
        <Button onClick={action('clicked')} variant="outline-primary">
          {'Ghost Button'}
        </Button>
        <Button onClick={action('clicked')} size="sm" variant="outline-primary">
          {'Small Ghost Button'}
        </Button>
      </div>
    ),
  ...
  .add(
    ...
    () => (
      <div>
        ...
        <Button onClick={action('clicked')} size="sm" variant="warning">
  ...
  .add(
    ...
    () => (
      <div>
        ...
        <Button onClick={action('clicked')} size="sm" variant="danger">
          {'Danger Small Button'}
        </Button>
      </div>
    ),
  ...
  .add(
    ...
    () => (
      <div>
        ...
        <Button onClick={action('clicked')} size="sm" variant="success">
...
storiesOf('Dropdown Button', module)
  ...
  .add(
    ...
    () => (
      <div>
        <DropdownButton disabled title="Actions" variant="primary" />
      </div>
    ),
    {
  ...
  <Navbar expand="lg" variant="">
    ...
    <Navbar.Collapse id="mb-navbar-nav">
      <Nav className="mr-auto">
        <Nav.Link href="#login" onClick={noop}>
          {'Login'}
        </Nav.Link>
        <Nav.Link href="#register" onClick={noop}>
          {'Register'}
        </Nav.Link>
